        ...
        <div className='flex md:flex-row flex-col-reverse items-center
          ...
          <div className='p-2 content'>
            <div className='text-gray-300 my-3'>
              ...
              <a
                download='https://drive.google.com/file/d/15EjkGvfKBsepik_nmOfCKHJlpdQQ9VZi/view?usp=sharing'
                href='https://drive.google.com/file/d/15EjkGvfKBsepik_nmOfCKHJlpdQQ9VZi/view?usp=sharing'>
