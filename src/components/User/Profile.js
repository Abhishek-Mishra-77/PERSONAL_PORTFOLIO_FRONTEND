          ...
          <div className='flex flex-col justify-center items-center mt-4'>
            ...
            <div className='text-2xl sm:text-3xl mt-4 flex items-center justify-center md:justify-start gap-4 sm:gap-6'>
              {social_media?.map((icon) => (
                <div
                  key={icon._id}
                  className='text-gray-500  rounded-2xl cursor-pointer flex justify-center items-center hover:text-cyan-500 transition-transform transform hover:scale-110 duration-300'
                >
                  <a className='p-4 text-4xl hover:text-blue-500 transition-colors duration-300' href={icon.link} target='_blank' rel='noopener noreferrer'>
